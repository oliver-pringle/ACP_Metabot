...
public class WatchService
{
        ...
        RegisterWatchRequest req, CancellationToken ct)
    {
        ...
        var initial = await _search.SearchAsync(req.Query, InitialMatchLimit, minScore, priceMax, ct);
    ...
    private async Task<bool> PollOneAsync(Watch w, CancellationToken ct)
    {
        ...
        var results = await _search.SearchAsync(w.Query, InitialMatchLimit, minScore, priceMax, ct);
