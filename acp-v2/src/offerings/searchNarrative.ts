...
export const searchNarrative: Offering = {
  ...
  requirementSchema: {
    ...
    properties: {
      ...
      previousQueries: {
        ...
        maxItems: 5,
        description:
          "Optional prior queries this session (max 5; each ≤ 200 chars). Helps the narrator avoid restating context the buyer already saw.",
      },
      marketplace: {
        type: "string",
        enum: ["v1", "v2"],
  ...
  deliverableSchema: {
    ...
    properties: {
      ...
      count: { type: "integer", description: "Number of offerings narrated (≤ 5)." },
      results: {
        type: "array",
