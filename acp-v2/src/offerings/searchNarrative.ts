    ...
    properties: {
      ...
      results: {
        ...
        items: {
          type: "object",
          properties: {
            offeringId:         { type: "integer", description: "Internal indexer ID of the offering." },
            ...
            description:        { type: "string", description: "Free-text description as registered on the marketplace." },
            ...
            chain:              { type: "string", description: "Chain id (or canonical name) where the offering is registered." },
